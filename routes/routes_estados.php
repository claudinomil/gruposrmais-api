...
Route::prefix('estados')->group(function () {
    ...
    Route::get('/search/{field}/{value}/{empresa_id}', [EstadoController::class, 'search'])->middleware(['auth:api', 'scope:claudino']);
    Route::get('/research/{fieldSearch}/{fieldValue}/{fieldReturn}/{empresa_id}', [EstadoController::class, 'research'])->middleware(['auth:api', 'scope:claudino']);
    Route::post('/store/{empresa_id}', [EstadoController::class, 'store'])->middleware(['auth:api', 'scope:claudino']);
    //Route::put('/update/{id}/{empresa_id}', [EstadoOrganController::class, 'update'])->middleware(['auth:api', 'scope:claudino']);
