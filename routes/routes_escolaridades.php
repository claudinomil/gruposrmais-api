...
Route::prefix('escolaridades')->group(function () {
    ...
    Route::get('/search/{field}/{value}/{empresa_id}', [EscolaridadeController::class, 'search'])->middleware(['auth:api', 'scope:claudino']);
    Route::get('/research/{fieldSearch}/{fieldValue}/{fieldReturn}/{empresa_id}', [EscolaridadeController::class, 'research'])->middleware(['auth:api', 'scope:claudino']);
