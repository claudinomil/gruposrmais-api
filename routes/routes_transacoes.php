...
Route::prefix('transacoes')->group(function () {
    ...
    Route::get('/search/{field}/{value}/{empresa_id}', [TransacaoController::class, 'search'])->middleware(['auth:api', 'scope:claudino']);
    Route::get('/research/{fieldSearch}/{fieldValue}/{fieldReturn}/{empresa_id}', [TransacaoController::class, 'research'])->middleware(['auth:api', 'scope:claudino']);
