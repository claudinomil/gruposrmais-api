...
Route::prefix('situacoes')->group(function () {
    ...
    Route::get('/search/{field}/{value}/{empresa_id}', [SituacaoController::class, 'search'])->middleware(['auth:api', 'scope:claudino']);
    Route::get('/research/{fieldSearch}/{fieldValue}/{fieldReturn}/{empresa_id}', [SituacaoController::class, 'research'])->middleware(['auth:api', 'scope:claudino']);
