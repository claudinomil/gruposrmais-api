...
class ServicoObserver
{
    ...
    {
        //gravar transacao
        Transacoes::transacaoRecord(1, 'servicos', $servico, $servico);
    }
    ...
    public function updated(Servico $servico)
    {
        ...
        Transacoes::transacaoRecord(2, 'servicos', $beforeData, $laterData);
    }

    public function deleted(Servico $servico)
    {
        //gravar transacao
        Transacoes::transacaoRecord(3, 'servicos', $servico, $servico);
    }
}
