...
class FornecedorObserver
{
    ...
    {
        //gravar transacao
        Transacoes::transacaoRecord(1, 'fornecedores', $fornecedor, $fornecedor);
    }
    ...
    public function updated(Fornecedor $fornecedor)
    {
        ...
        Transacoes::transacaoRecord(2, 'fornecedores', $beforeData, $laterData);
    }

    public function deleted(Fornecedor $fornecedor)
    {
        //gravar transacao
        Transacoes::transacaoRecord(3, 'fornecedores', $fornecedor, $fornecedor);
    }
}
