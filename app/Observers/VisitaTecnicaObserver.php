...
class VisitaTecnicaObserver
{
    ...
    {
        //gravar transacao
        Transacoes::transacaoRecord(1, 'visitas_tecnicas', $visita_tecnica, $visita_tecnica);
    }
    ...
    public function updated(VisitaTecnica $visita_tecnica)
    {
        ...
        Transacoes::transacaoRecord(2, 'visitas_tecnicas', $beforeData, $laterData);
    }

    public function deleted(VisitaTecnica $visita_tecnica)
    {
        //gravar transacao
        Transacoes::transacaoRecord(3, 'visitas_tecnicas', $visita_tecnica, $visita_tecnica);
    }
}
