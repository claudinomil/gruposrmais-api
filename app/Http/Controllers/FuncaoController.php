...
class FuncaoController extends Controller
{
    ...
    {
        $registros = $this->funcao->where('funcoes.empresa_id', '=', $empresa_id)->where($field, 'like', '%'.$value.'%')->get();
    ...
    {
        $registros = $this->funcao->where('funcoes.empresa_id', '=', $empresa_id)->where($fieldSearch, 'like', '%' . $fieldValue . '%')->get($fieldReturn);
