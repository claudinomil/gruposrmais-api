...
class SubmodulosSeeder extends Seeder
{
    public function run()
    {
        DB::table('submodulos')->insert([
            ...
            ['id' => '24', 'modulo_id' => '2', 'name' => 'Tipos Serviço', 'menu_text' => 'Tipos Serviço', 'menu_url' => 'servico_tipos', 'menu_route' => 'servico_tipos', 'menu_icon' => 'fas fa-angle-right', 'prefix_permissao' => 'servico_tipos', 'prefix_route' => 'servico_tipos', 'viewing_order' => 70],
