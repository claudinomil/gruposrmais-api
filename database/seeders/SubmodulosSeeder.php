...
class SubmodulosSeeder extends Seeder
{
    public function run()
    {
        DB::table('submodulos')->insert([
            ...
            ['id' => '20', 'modulo_id' => '2', 'name' => 'Clientes', 'menu_text' => 'Clientes', 'menu_url' => 'clientes', 'menu_route' => 'clientes', 'menu_icon' => 'fas fa-angle-right', 'prefix_permissao' => 'clientes', 'prefix_route' => 'clientes', 'viewing_order' => 90],
